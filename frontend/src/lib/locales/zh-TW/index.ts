export const zhTW = {
  ...
  auth: {
    loginTitle: "OpenNote",
    loginDesc: "登入你的 IDE 級研究空間，安全且私密地整理知識。",
    ...
    orContinueWith: "或使用密碼繼續",
    portalHighlight: "命令驅動的筆記本",
    enterpriseReady: "加密工作階段，工作區級存取控制。",
  },
  navigation: {
    collect: "採集",
    process: "處理",
  ...
  notebooks: {
    ...
    ideSubtitle: "知識工作台",
    ideDescription: "在像現代 IDE 一樣的工作區中整理研究、撰寫筆記並編排來源。",
    ideHint: "在筆記中輸入 / 插入 Notion 風格區塊。",
    ideShortcut: "按 ⌘K 開啟快捷命令。",
    archived: "已封存",
    archive: "封存",
    unarchive: "取消封存",
  ...
  sources: {
    ...
    slashHint: "輸入 / 插入區塊",
    markdownHint: "支援 Markdown + Notion 風格區塊",
    slashMenuTitle: "斜線命令",
    slashMenuEmpty: "沒有符合的命令",
    slashHeading: "標題",
    slashHeadingDesc: "開始新的段落",
    slashTodo: "待辦清單",
    slashTodoDesc: "以核取方塊追蹤任務",
    slashCallout: "提示區塊",
    slashCalloutDesc: "強調重要說明",
    slashCode: "程式碼區塊",
    slashCodeDesc: "插入含語法的程式碼",
    slashTable: "表格",
    slashTableDesc: "整理結構化資料",
    saveNote: '儲存筆記',
    createNoteBtn: "新增筆記",
    urlLabel: 'URL(s) *',
    fileLabel: '檔案(s) *',
  ...
  advanced: {
    ...
    updateAvailableDesc: "OpenNote 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    title: "模型管理",
    desc: "設定用於 OpenNote 不同用途的 AI 模型",
    ...
    apiKey: "API 密鑰",
    baseUrl: "基礎 URL",
    apiKeyPlaceholder: "選填：輸入提供商 API 密鑰",
    apiKeyHint: "與此模型一同儲存，並優先於環境變數使用。",
    baseUrlPlaceholder: "選填：覆寫提供商基礎 URL",
    baseUrlHint: "用於 OpenAI 相容服務或自訂端點。",
    capabilities: "功能",
    enabled: "已啟用",
    disabled: "已禁用",
    ...
    aiProviders: "AI 提供商",
    providerConfigDesc: "透過環境變數或應用程式內 API 密鑰設定提供商以啟用其模型。",
    ...
    defaultAssignmentsDesc: "設定用於 OpenNote 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，OpenNote 可能無法正常運行。",
