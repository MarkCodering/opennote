export const ptBR = {
  common: {
    ...
    statusReady: "Tudo pronto",
    aiReady: "Copilotos de IA online",
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do OpenNote não pôde ser alcançado",
    ...
    docLink: "Documentação do OpenNote",
  ...
  auth: {
    loginTitle: "OpenNote",
    loginDesc: "Entre no seu espaço de pesquisa estilo IDE com trabalho de conhecimento seguro e privado.",
    ...
    orContinueWith: "ou continue com senha",
    portalHighlight: "Cadernos com comandos",
    enterpriseReady: "Sessões criptografadas com controles de acesso de nível empresarial.",
  },
  navigation: {
    collect: "Coletar",
    process: "Processar",
  ...
  notebooks: {
    ...
    ideSubtitle: "Workbench de conhecimento",
    ideDescription: "Fixe pesquisas, crie notas e orquestre fontes em um espaço inspirado em IDE moderna.",
    ideHint: "Digite / nas notas para inserir blocos ao estilo Notion.",
    ideShortcut: "Pressione ⌘K para comandos rápidos.",
    archived: "Arquivado",
    archive: "Arquivar",
  ...
  sources: {
    ...
    slashHint: "Digite / para inserir blocos",
    markdownHint: "Markdown + blocos estilo Notion suportados",
    slashMenuTitle: "Comandos com /",
    slashMenuEmpty: "Nenhum comando encontrado",
    slashHeading: "Título",
    slashHeadingDesc: "Inicie uma nova seção",
    slashTodo: "Lista de tarefas",
    slashTodoDesc: "Acompanhe tarefas com checkboxes",
    slashCallout: "Destaque",
    slashCalloutDesc: "Realce uma observação importante",
    slashCode: "Bloco de código",
    slashCodeDesc: "Insira um bloco com sintaxe",
    slashTable: "Tabela",
    slashTableDesc: "Organize dados em tabela",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o OpenNote exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do OpenNote está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    desc: "Configure modelos de IA para diferentes propósitos no OpenNote",
    ...
    apiKey: "Chave da API",
    baseUrl: "URL Base",
    apiKeyPlaceholder: "Opcional: informe a chave da API do provedor",
    apiKeyHint: "Salva junto com este modelo e substitui variáveis de ambiente.",
    baseUrlPlaceholder: "Opcional: sobrescreva a URL base do provedor",
    baseUrlHint: "Use para servidores compatíveis com OpenAI ou endpoints personalizados.",
    ...
    providerConfigDesc: "Configure provedores via variáveis de ambiente ou chaves de API no app para habilitar seus modelos.",
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no OpenNote",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O OpenNote pode não funcionar corretamente sem eles.",
