export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The OpenNote API server could not be reached",
    ...
    docLink: "OpenNote Documentation",
  ...
  auth: {
    loginTitle: "OpenNote",
    loginDesc: "Sign in to your IDE-grade research space with secure, private knowledge work.",
    ...
    orContinueWith: "or continue with password",
    portalHighlight: "Command-powered notebooks",
    enterpriseReady: "Encrypted sessions with workspace-grade access controls.",
  },
  navigation: {
    collect: "Collect",
    process: "Process",
  ...
  notebooks: {
    ...
    ideSubtitle: "Knowledge Workbench",
    ideDescription: "Pin research, craft notes, and orchestrate sources in a workspace designed like a modern IDE.",
    ideHint: "Type / in notes to insert Notion-style blocks.",
    ideShortcut: "Press ⌘K for quick commands.",
    archived: "Archived",
    archive: "Archive",
    unarchive: "Unarchive",
  ...
  sources: {
    ...
    slashHint: "Type / to insert blocks",
    markdownHint: "Markdown + Notion-style blocks supported",
    slashMenuTitle: "Slash commands",
    slashMenuEmpty: "No matching commands",
    slashHeading: "Heading",
    slashHeadingDesc: "Start a new section",
    slashTodo: "Todo list",
    slashTodoDesc: "Track tasks with checkboxes",
    slashCallout: "Callout",
    slashCalloutDesc: "Highlight an important note",
    slashCode: "Code block",
    slashCodeDesc: "Insert a syntax-friendly block",
    slashTable: "Table",
    slashTableDesc: "Lay out structured data",
    saveNote: 'Save Note',
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow OpenNote to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of OpenNote is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    desc: "Configure AI models for different purposes across OpenNote",
    ...
    apiKey: "API Key",
    baseUrl: "Base URL",
    apiKeyPlaceholder: "Optional: enter a provider API key",
    apiKeyHint: "Saved with this model and used instead of environment variables.",
    baseUrlPlaceholder: "Optional: override the provider base URL",
    baseUrlHint: "Use this for OpenAI-compatible servers or custom endpoints.",
    ...
    providerConfigDesc: "Configure providers through environment variables or in-app API keys to enable their models.",
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across OpenNote",
    missingRequiredModels: "Missing required models: {models}. OpenNote may not function properly without these.",
