export const zhCN = {
  ...
  auth: {
    loginTitle: "OpenNote",
    loginDesc: "登录到你的 IDE 级研究空间，安全私密地整理知识。",
    ...
    orContinueWith: "或使用密码继续",
    portalHighlight: "命令驱动的笔记本",
    enterpriseReady: "加密会话，工作区级访问控制。",
  },
  navigation: {
    collect: "采集",
    process: "处理",
  ...
  notebooks: {
    ...
    ideSubtitle: "知识工作台",
    ideDescription: "在像现代 IDE 一样的工作区中整理研究、撰写笔记并编排来源。",
    ideHint: "在笔记中输入 / 插入 Notion 风格区块。",
    ideShortcut: "按 ⌘K 打开快捷命令。",
    archived: "已归档",
    archive: "归档",
    unarchive: "取消归档",
  ...
  sources: {
    ...
    slashHint: "输入 / 插入区块",
    markdownHint: "支持 Markdown + Notion 风格区块",
    slashMenuTitle: "斜杠命令",
    slashMenuEmpty: "没有匹配的命令",
    slashHeading: "标题",
    slashHeadingDesc: "开始新的章节",
    slashTodo: "待办清单",
    slashTodoDesc: "用复选框跟踪任务",
    slashCallout: "提示块",
    slashCalloutDesc: "突出重要说明",
    slashCode: "代码块",
    slashCodeDesc: "插入带语法的代码块",
    slashTable: "表格",
    slashTableDesc: "整理结构化数据",
    saveNote: '保存笔记',
    createNoteBtn: '创建笔记',
    urlLabel: 'URL(s) *',
    fileLabel: '文件(s) *',
  ...
  models: {
    title: "模型管理",
    desc: "配置用于 OpenNote 不同用途的 AI 模型",
    ...
    apiKey: "API 密钥",
    baseUrl: "基础 URL",
    apiKeyPlaceholder: "可选：输入服务商 API 密钥",
    apiKeyHint: "与该模型一同保存，并优先于环境变量使用。",
    baseUrlPlaceholder: "可选：覆盖服务商基础 URL",
    baseUrlHint: "用于 OpenAI 兼容服务或自定义端点。",
    capabilities: "功能",
    enabled: "已启用",
    disabled: "已禁用",
    ...
    aiProviders: "AI 服务商",
    providerConfigDesc: "通过环境变量或应用内 API 密钥配置服务商以启用其模型。",
    ...
    defaultAssignmentsDesc: "配置用于 OpenNote 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，OpenNote 可能无法正常运行。",
